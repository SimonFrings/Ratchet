...
class TopicTest extends TestCase {
    ...
    public function testBroadcast() {
        ...
        $first  = $this->getMockBuilder('Ratchet\\Wamp\\WampConnection', array('send'), array($this->getMockBuilder('\\Ratchet\\ConnectionInterface')->getMock()))->getMock();
        $second = $this->getMockBuilder('Ratchet\\Wamp\\WampConnection', array('send'), array($this->getMockBuilder('\\Ratchet\\ConnectionInterface')->getMock()))->getMock();
    ...
    public function testBroadcastWithExclude() {
        ...
        $first  = $this->getMockBuilder('Ratchet\\Wamp\\WampConnection', array('send'), array($this->getMockBuilder('\\Ratchet\\ConnectionInterface')->getMock()))->getMock();
        $second = $this->getMockBuilder('Ratchet\\Wamp\\WampConnection', array('send'), array($this->getMockBuilder('\\Ratchet\\ConnectionInterface')->getMock()))->getMock();
        $third  = $this->getMockBuilder('Ratchet\\Wamp\\WampConnection', array('send'), array($this->getMockBuilder('\\Ratchet\\ConnectionInterface')->getMock()))->getMock();
